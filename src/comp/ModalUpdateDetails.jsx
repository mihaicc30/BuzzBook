...
export default function ModalUpdateDetails() {
  const { venueID, date, updateContext, contextBookings, contextCovers, modalData, modalUpdateDetails } = useContext(AppContext)
    ...
    >
      <div className={`relative flex flex-col h-[100svh] w-[50svw] max-sm:w-[80svw] min-w-[280px] z-30 bg-white overflow-y-auto overflow-x-hidden transition ${fadeOut ? "animate-fadeLeftToRight" : "animate-fadeRightToLeft"} `}>
        ...
        {modalUpdateDetails[0] === "userDetails" && (
          <div className="grid grid-cols-1 px-4 gap-8 relative">
        ...
        {modalUpdateDetails[0] === "bookingDetails" && (
          <div className="grid grid-cols-1 px-4 gap-8 relative">
            ...
            <div className="flex flex-col gap-x-2 capitalize">
              ...
              <select id="modalTempSection" value={Object.keys(modalUpdateDetails[1].assignedSlot)[0]} onChange={(e) => handleChange("section", e.target.value)}>
            ...
            <div className="flex flex-col gap-x-2 capitalize">
              ...
              <select id="modalTempTable" value={Object.keys(Object.values(modalUpdateDetails[1].assignedSlot)[0])[0] || ""} onChange={(e) => handleChange("table", e.target.value)}>
